---
title: "Review, Cleaning and Reorganization of Casco Bay OA Data"
...
Sudden drops in pH to unlikely leves are one potnetial sign of problems wit hthe data.  Another sign is if the calculated alkalinity associated with a low pH observation is unreasonable for sea water (say below about 1000).
...
Here we follow a formula for calculating a "Temperature Corrected" version of pCO~2~, which is derived from methods in  Takehashi et al. 2002.  
